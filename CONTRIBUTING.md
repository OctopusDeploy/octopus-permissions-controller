...
This project is built, tested, and released by workflows defined in GitHub Actions (see [Actions](../actions/) for more information). Releases are managed manually via Github releases.
...
This project employs [branch protection](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/defining-the-mergeability-of-pull-requests/managing-a-branch-protection-rule); the `main` branch is protected. Therefore, your changes MUST be committed to a branch and submitted as a pull request. Also, this project requires the use of [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) for all commit messages.
...
To release a new version, create a Github release in the repository. You will require appropriate permissions. 

The release and tag should share the same name and be in the format `v[major].[minor].[patch]` (e.g. `v1.0.0`). Once the release is created, a workflow will start the publishing process.

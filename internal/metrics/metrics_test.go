...
var _ = Describe("Metrics Test", func() {
	...
	Context("Real Engine Tests", func() {
		...
		Context("Kubernetes Resource Metrics with Mock Engine", func() {
			It("should accurately collect Kubernetes resource metrics", func() {
				...
				mockEngine := new(mocks.MockEngine)

				// Set up mock expectations for GetServiceAccounts (3 SAs total)
				mockEngine.On("GetServiceAccounts", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*corev1.ServiceAccount](func(yield func(*corev1.ServiceAccount) bool) {
						sa1 := &corev1.ServiceAccount{
							ObjectMeta: metav1.ObjectMeta{
								Name: "sa1", Namespace: "namespace1",
							},
						}
						sa2 := &corev1.ServiceAccount{
							ObjectMeta: metav1.ObjectMeta{
								Name: "sa2", Namespace: "namespace1",
							},
						}
						sa3 := &corev1.ServiceAccount{
							ObjectMeta: metav1.ObjectMeta{
								Name: "sa3", Namespace: "namespace2",
							},
						}
						yield(sa1)
						yield(sa2)
				...
				// Set up mock expectations for GetRoles (2 Roles total)
				mockEngine.On("GetRoles", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*rbacv1.Role](func(yield func(*rbacv1.Role) bool) {
						role1 := &rbacv1.Role{ObjectMeta: metav1.ObjectMeta{Name: "role1", Namespace: "namespace1"}}
						role2 := &rbacv1.Role{ObjectMeta: metav1.ObjectMeta{Name: "role2", Namespace: "namespace2"}}
						yield(role1)
						yield(role2)
					}),
					nil,
				...
				// Set up mock expectations for GetClusterRoles (2 ClusterRoles)
				mockEngine.On("GetClusterRoles", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*rbacv1.ClusterRole](func(yield func(*rbacv1.ClusterRole) bool) {
						cr1 := &rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "clusterrole1"}}
						cr2 := &rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "clusterrole2"}}
						yield(cr1)
						yield(cr2)
					}),
					nil,
				...
				// Set up mock expectations for GetRoleBindings (3 RoleBindings total)
				mockEngine.On("GetRoleBindings", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*rbacv1.RoleBinding](func(yield func(*rbacv1.RoleBinding) bool) {
						rb1 := &rbacv1.RoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "rb1", Namespace: "namespace1"}}
						rb2 := &rbacv1.RoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "rb2", Namespace: "namespace1"}}
						rb3 := &rbacv1.RoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "rb3", Namespace: "namespace2"}}
						yield(rb1)
						yield(rb2)
						yield(rb3)
					}),
				...
				// Set up mock expectations for GetClusterRoleBindings (1 ClusterRoleBinding)
				mockEngine.On("GetClusterRoleBindings", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*rbacv1.ClusterRoleBinding](func(yield func(*rbacv1.ClusterRoleBinding) bool) {
						crb1 := &rbacv1.ClusterRoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "crb1"}}
						yield(crb1)
					}),
					nil,
				)

				// Set up mock expectations for GetWorkloadServiceAccounts (2 WSAs)
				mockEngine.On("GetWorkloadServiceAccounts", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*v1beta1.WorkloadServiceAccount](func(yield func(*v1beta1.WorkloadServiceAccount) bool) {
						wsa1 := &v1beta1.WorkloadServiceAccount{
							ObjectMeta: metav1.ObjectMeta{
								Name: "wsa1", Namespace: "namespace1",
							},
						}
						wsa2 := &v1beta1.WorkloadServiceAccount{
							ObjectMeta: metav1.ObjectMeta{
								Name: "wsa2", Namespace: "namespace1",
							},
						}
						yield(wsa1)
						yield(wsa2)
				...
				// Set up mock expectations for GetClusterWorkloadServiceAccounts (1 CWSA)
				mockEngine.On("GetClusterWorkloadServiceAccounts", mock.MatchedBy(func(ctx context.Context) bool { return true })).Return(
					iter.Seq[*v1beta1.ClusterWorkloadServiceAccount](func(yield func(*v1beta1.ClusterWorkloadServiceAccount) bool) {
						cwsa1 := &v1beta1.ClusterWorkloadServiceAccount{ObjectMeta: metav1.ObjectMeta{Name: "cwsa1"}}
						yield(cwsa1)
					}),
					nil,
				)

				// Set up mock expectations for GetScopeToSA (3 distinct scopes)
				mockEngine.On("GetScopeToSA").Return(
					map[types.Scope]rules.ServiceAccountName{

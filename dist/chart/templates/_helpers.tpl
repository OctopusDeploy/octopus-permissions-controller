...
*/}}
{{- define "octopus-permissions-controller.name" -}}
...
*/}}
{{- define "octopus-permissions-controller.fullname" -}}
...
*/}}
{{- define "octopus-permissions-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "octopus-permissions-controller.resourceName" -}}
{{- $fullname := include "octopus-permissions-controller.fullname" .context }}
{{- $suffix := .suffix }}
